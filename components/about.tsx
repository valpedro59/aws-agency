            ...
            <div className="max-w-screen-xl mx-auto items-center space-y-8 p-11">
                ...
                <div>
                    ...
                    <div className="text-center flex flex-col justify-center items-center gap-4" data-aos="fade-right">
                        <p>composée de conseillers en communication, de designers, de développeurs, de professionnels du référencement qui mettent tout en oeuvre pour faire de votre projet une réussite.</p>
                        <p>
